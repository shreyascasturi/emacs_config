...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "magit-autorevert" '("magit-")))
...
;;;***

;;;### (autoloads nil nil ("magit-core.el" "magit-pkg.el" "magit-version.el")
;;;;;;  (0 0 0 0))
